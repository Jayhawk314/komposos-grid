...
- Measured value: **$0**
- Proxy value: **$225,692,599**
- Upper-bound value: **$172,470,248**
- Reported value: **$398,162,847**
...
| validate_proxy | Validate proxy congestion value for CISO-SRP | CISO-SRP | measured_proxy | 10,099,478 MWh gross interchange | $141,660,273 | Replace hub/price-spread proxy with nodal LMP or direct congestion-cost evidence. | Hub proxy has weak flow/price alignment; Proxy value depends on hub-to-BA mapping and should not be treated as direct settlement cost. |
| validate_proxy | Validate proxy congestion value for BPAT-CISO | BPAT-CISO | measured_proxy | 5,458,963 MWh gross interchange | $51,709,377 | Replace hub/price-spread proxy with nodal LMP or direct congestion-cost evidence. | Hub proxy has mixed flow/price alignment; Proxy value depends on hub-to-BA mapping and should not be treated as direct settlement cost. |
...
| validate_proxy | Validate proxy congestion value for BPAT-NEVP | BPAT-NEVP | measured_proxy | 569,040 MWh gross interchange | $2,155,331 | Replace hub/price-spread proxy with nodal LMP or direct congestion-cost evidence. | Hub proxy has mixed flow/price alignment; Proxy value depends on hub-to-BA mapping and should not be treated as direct settlement cost. |
| validate_proxy | Validate proxy congestion value for PACW-CISO | PACW-CISO | measured_proxy | 74,572 MWh gross interchange | $706,374 | Replace hub/price-spread proxy with nodal LMP or direct congestion-cost evidence. | Hub proxy is directionally supportive, but proxy value depends on hub-to-BA mapping and should not be treated as direct settlement cost. |
